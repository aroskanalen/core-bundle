...
use Os2Display\CoreBundle\Entity\SlideTemplate;
...
class TemplateService {
  ...
  public function enableScreenTemplates($enabledTemplates) {
    ...
    $templateRepository = $doctrine->getRepository('Os2DisplayCoreBundle:ScreenTemplate');
  ...
  public function enableSlideTemplates($enabledTemplates) {
    $doctrine = $this->container->get('doctrine');
    $templateRepository = $doctrine->getRepository('Os2DisplayCoreBundle:SlideTemplate');
    $templates = $templateRepository->findAll();
    $entityManager = $doctrine->getManager();
